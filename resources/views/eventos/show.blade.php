...
@section('content')
<div class="row">
    <!-- Formularço de envio de Pergunta (TICKET #005: exige login) -->
    <div class="col-md-5 mb-4">
        <div class="card shadow-sm p-3">
            ...
            @else
                <p class="text-secondary mb-3">Você precisa estar logado para enviar uma pergunta.</p>
                <a href="{{ route('login') }}" class="btn btn-primary w-100 fw-bold">Fazer login para perguntar</a>
            @endauth
        </div>
    </div>
    ...
    <div class="col-md-7">
        ...
        @if(method_exists($perguntas, 'links'))
            ...
            {{ $perguntas->links('pagination::bootstrap-5') }}
            </div>
        @endif
    </div>
</div>
